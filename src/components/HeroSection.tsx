      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="relative w-full max-w-[600px] aspect-[550/1195] md:max-w-none md:w-full md:h-full md:aspect-auto pointer-events-auto translate-y-16 sm:translate-y-20 md:translate-y-0">
            {/* Layer 2 — left hand (Mobile: slid slightly upwards top-[-6%]; PC: dead center left) */}
            <div
              ref={handLeftRef}
              className="absolute top-[-6%] md:top-[50%] md:-translate-y-1/2 left-0 md:left-[-5%] w-[84.6%] md:w-[44vw] max-w-[680px] pointer-events-none will-change-transform opacity-100 transition-transform duration-150 ease-out z-[4] rotate-[42.3deg] md:rotate-0 origin-top-left md:origin-center"
            >
            ...
            {/* Layer 4 — right hand (Mobile: slid slightly downwards top-[62%]; PC: dead center right) */}
            <div
              ref={handRightRef}
              className="absolute top-[62%] md:top-[50%] md:-translate-y-1/2 right-[-22%] md:right-[-5%] w-[70%] md:w-[44vw] max-w-[680px] pointer-events-none will-change-transform opacity-100 transition-transform duration-150 ease-out z-[4] rotate-[50deg] md:rotate-0 origin-right md:origin-center"
            >
